...
(function (window, $) {
  ...
  Wysiwyg.prototype.uploadImage = function (data, callback) {
    ...
    $.ajax({
      type: 'POST',
      url: config.BASE_URL + 'server/upload-image.php',
      data: data,
      contentType: false,
      processData: false,
      success: function (data) {
        self.setLoading(false);
        const url = config.BASE_URL + data;
        callback(url);
      }
    });
  };
  ...
  Wysiwyg.prototype.initEditFile = function () {
    ...
    $('.js-btn-save-edit').on('click', function (e) {
      ...
      self.uploadEditImage(data, function (serverData) {
        self.url = config.BASE_URL + serverData.url;
        self.editUrl = '';
  ...
  Wysiwyg.prototype.uploadEditImage = function (data, callback) {
    ...
    $.ajax({
      type: 'POST',
      url: config.BASE_URL + 'server/edit-image.php',
      ...
      success: function (data) {
        ...
        self.editUrl = config.BASE_URL + data.editUrl;
        self.updateModal();
      }
    });
  };
